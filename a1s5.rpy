...
a "\"Merci.\""
"Vieux Loup" "\"De rien.\""
"Et ainsi, le vieux loup se précipite hors de la salle de bain, nous laissant seuls tous les deux."
...
"Je ne sais pas s'il essaie juste de me remonter le moral, mais là encore, je suppose que les loups n'ont vraiment aucune idée de ce que sont les normes de beauté humaine."
...
m "\"Ouais ... est-ce qu'ils sont genre, d'accord avec ça, ce n'est pas offensant ? On dirait une plaisanterie.\""
...
a "\"Je euh ... j'ai oublié la raison pour laquelle tu es ici au départ.\""
"Je ne sais pas de quoi il parle un instant ... Puis je réalise."
"Nous ne sommes même pas censés savoir que l'autre existe."
"Tout cela est contraire à la loi."
m "\"Oh ... alors je suppose qu'on ne pourra pas faire ça, hein ?\""
...
m "\"Je ne sais pas, ils m'ont en bien mis un.\""
show ale serious u with dis
al "\"Évidemment ... Et de la poudre aussi.\""
"Je regarde Alex."
show ale smile e u with dis
al "\"Enfin, tu as l'air beau, c'est très audacieux.\""
m "\"Alors pourquoi tu n'es pas habillé en Meera ? On fait la même danse, non ?\""
...
al "\"Sérieusement ! Tu penses que je souhaites que tout Adastra voie mon torse nu ?\""
...
m "\"Alors pourquoi est-ce que Cassius et Amicus feraient campagne s'ils devaient simplement être choisis dans le cadre de ces épreuves ?\""
show ale tilt e u with dis
al "\"Eh bieeeen ... si la décision n'est pas claire, alors pourquoi ne pas choisir le loup qui a le plus de popularité auprès de votre peuple ? Ça augmente les chances de réélection.\""
"Amicus apparaît soudain à l'écran, assis, un projecteur sur lui alors qu'il commence à souffler dans le même instrument."
"Une fois de plus, ce son rauque et blattant qui me ferait grincer des dents s'il s'agissait d'un instrument humain lors d'un concert humain."
...
"Il y avait eu un petit mais certain espoir de mon côté qu'Alex pourrait nous aider ici, peut-être saboter la danse en notre faveur avec une chute ou un trébuchement, mais il semble qu'il ait tout misé dans la performance."
...
"Je suppose que je suis juste en colère contre tout ce système, que la responsabilité de rentrer chez moi repose sur moi autant que sur le type qui m'a amené ici en premier lieu."
"Ce n'est pas juste."
...
"Et je me surprends à choisir cette derniere, en gloussant au début avant de laisser échapper de grands éclats de rire."
...
"Je hausse les épaules."
m "\"Je ne sais pas, le Lingua n'essaye pas de comprendre l'intention aussi ? Peut-être que je suis censé entendre le \"vrai\" Language quand vous chantez. Ça s'est aussi produit quand tu faisais ta chanson, même si je ne m'en étais pas rendu compte à ce moment-là.\""
show ami embarrassed with dis
a "\"Oh...tu m'as entendu chanté ?\""
"Je peux entendre l'embarras dans la voix d'Amicus."
m "\"Ouais...Ça sonnait bien honnêtement. J'ai été un crétin quand je me suis plains à l'instant.\""
...
a "\"Tu ne connais pas le vrai Cass. Il se dégoute beaucoup lui-même.\""
...
show ami angry with dis
a "\"Ce n'est pas comme si J'AI BESOIN de toi pour le faire. Je peux m'en occuper moi-même.\""
m "\"Alors fais-le.\""
a "\"Je le ferai.\""
...
"Je critique souvent Amicus pour ses crises de colère, lui rappelant que cela ne nous aidera pas à bouder."
...
"Je fais un mouvement de va et vient en l'air."
m "\"... plus tard. Je ne suis tout simplement pas dans le bon état d'esprit pour le moment.\""
show ami with dis
a "\"Je comprends. Il était trop tôt pour ça... cependant, euh, peut-être que nous pourrions faire autre chose qui nous remonterait le moral à tous les deux ?\""
...
show ami embarrassed with dis
"Encore une fois, ce regard plein d'espoir et je me sens vraiment mal à nouveau pour lui."
...
"De plus, j'ai vraiment aimé nos petits câlins, donc un câlin plus long..."
...
"Ce câlin est juste si ... agréable."
...
"A l'origine, je voulais juste qu'il se sente mieux, mais il avait raison de me consoler."
...
a "\"Ah.\""
"Amicus me palpe un peu plus, faisant ces petits mouvements comme s'il essayait de me sentir le plus possible sans être évident là-dessus."
a "\"C'est comment, \"sortir ensemble\" sur ta planète ?\""
...
al "\"Eh bien, je lui recommande d'étudier les triumvirats et leurs villes, ne serait-ce que pour trouver le meilleur moyen de les convaincre lors de la deuxième épreuve.\""
"Ouaip, pas de doute qu'il m'offrait des informations."
...
n "\"Ça l'est en effet, mais c'est une chose à laquelle on s'habitue.\""
"Alex et Neferu se sourient pendant un moment, et je fronce les sourcils au chat, me demandant ce qu'il fait."
show nef smile a with dis
...
n "\"Et je te reverrai demain pour m'assurer que tu le fasses !\""
...
show ale shocked with dis
al "\"Euh, oh, je-\""
"Neferu tend à nouveau se patte."
show ale embarrassed with dis
"Alex tousse maladroitement avant de tendre la main pour la prendre."
show nef smile eyes a with dis
n "\"Fantastique, tu es toujours de si bonne compagnie. Souhaites-tu également nous rejoindre, [mc] ?\""
...
"Je me rappelle aussi que je dois demander à Alex pourquoi il a révelé à Neferu le foutu secret de mon intelligence."
...
a "\" Ah, j'ai probablement gâché ça, hein ? Eh bien, j'espère que le message est passé clairement ? Qu'en penses-tu ?\""
m "\"Je - je suis abasourdi.\""
show ami smile with dis
a "\"Et c'est ... une bonne chose ?\""
m "\"Amicus, qu'est-ce qui se passe ?\""
show ami embarrassed with dis
a "\"J'ai fait quelque chose de mal, pas vrai ?\""
m "\"Eh bien, je veux dire ... tu sais ce que tu es en train de faire ?\""
"Tout cela est dingue, mais le comportement d'Amicus ne correspond pas vraiment à la proposition qu'il vient de faire."
...
m "\"Ben oui ! En fait, tu n'as pas nécessairement besoin d'être {i}amoureux{/ i} pour sortir avec quelqu'un, mais l'intention est généralement de {i}trouver{/ i} l'amour ...\""
show ami frustrated with dis
a "\"Ô dieux, ton intention était juste de m'humilier après la danse ?\""
m "\"De quoi tu parles ? Comment j'étais censé savoir que tu planifierais ça ?\""
show ami serious crossed with dis
a "\"Je pense que le fait de poser ces questions l'a rendu assez évident.\""
m "\"Tu te fais des idées.\""
show ami angry with dis
a "\"Clairement.\""
...
"Puis je tends la main pour la poser sur sa large épaule."
...
show ami serious with dis
a "\"C'est pas grave. Comme tu l'as dit, je me fais des idées.\""
...
m "\"Elles ont ton odeur.\""
show ami embarrassed with dis
a "\"Euh, oui.\""
m "\"Elles sont très belles.\""
show ami crossed serious with dis
a "\"Merci.\""
...
show ami embarrassed with dis
a "\"Comme ce concept de sortir ensemble que vous avez. Tu étais d'accord pour m'accorder des faveurs sexuelles. Ça veut dire que tu as également des sentiments amoureux pour moi ?\""
"Je rougis."
...
a "\"Je crois que je comprends.\""
"Je me vois redevenir rouge, j'aurais aimé garder la bouche fermée."
a "\"Dans ce cas, peut-être que je pourrais dire oui aussi.\""
...
show ami crossed serious with dis
"Amicus fronce soudainement les sourcils."
...
"En réalité, nous rions et parlons aussi facilement que nous l'avons toujours fait, le loup me donnant un coup de coude toutes les quelques minutes pour ponctuer quelque chose qu'il dit, chacun me faisant trébucher."
scene bg palace1 with dissolve
show ami with dissolve
a "\"Sinon, Cass a tendance à bégayer sur ses mots devant une foule nombreuse. Un rhéteur ne peut pas faire grand-chose à ce sujet !\""
stop loop fadeout 3.0
...
"Le loup commence à avancer vers Cassius, s'arrêtant à quelques pas."
...
"Je sais que Cassius essaie juste de sortir Amicus de ses gonds."
...
c "\"Amicus, espèce de bâtard ! Lève-queue ! Avaleur de sabres !\""
